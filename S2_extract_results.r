...
for(model in 1:4){
   ...
   cols = c("black", "#5e4fa2", "#21908CFF", "grey","#fdae61")
   ...
   m2 = m
   m2$covNames[2] = m$covNames[3]
   m2$covNames[3] = m$covNames[2]
   plotBeta(m2, post=postBeta2, supportLevel = 0.95,param="Sign",spNamesNumbers=c(FALSE,FALSE))
   #plotBeta(m, post=postBeta, supportLevel = 0.95,param="Sign",spNamesNumbers=c(FALSE,FALSE))
   dev.off()
   # effect of year
   c(mean(postBeta$support[2,]>0.95),mean(postBeta$support[2,]<0.05))
   # effect of year x temperature
   c(mean(postBeta$support[4,]>0.95),mean(postBeta$support[4,]<0.05))
   #EC, EW, LC, LW
   c(mean(postBeta$support[4,]>0.95 & postBeta$mean[2,]<0)/mean(postBeta$mean[2,]<0),
     mean(postBeta$support[4,]<0.05 & postBeta$mean[2,]<0)/mean(postBeta$mean[2,]<0),
     mean(postBeta$support[4,]<0.05 & postBeta$mean[2,]>0)/mean(postBeta$mean[2,]>0),
     mean(postBeta$support[4,]>0.95 & postBeta$mean[2,]>0)/mean(postBeta$mean[2,]>0))
   res=NULL
